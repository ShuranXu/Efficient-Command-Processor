		...
		uint16_t *buff)
{
	...
	char msg[128];
	sprintf(msg, "Generated %d samples at %d Hz; computed period = %d samples\r\n", \
			sampling_stats.total_samples, sampling_stats.tone_freq, \
			sampling_stats.samples_per_cycle);
	HUFF_PRINT(msg);
}
